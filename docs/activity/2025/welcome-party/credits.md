...
const performers = [
  ...
  { avatar: qq('1404921055'), name: '辂木', title: '夏樱乐团管弦组 · 长笛', desc:'吹奏乐手摩多摩多' },
  { avatar: qq('1804183397'), name: '滑瓢', title: '夏樱乐团管弦组 · 小号', desc:'玩的开心嗬' },
  { avatar: qq('2550838863'), name: 'Animnia', title: '夏樱乐团管弦组 · 萨克斯', desc:'温暖' },
